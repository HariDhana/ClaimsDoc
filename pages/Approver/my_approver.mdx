...
The My Approver section allows users to view information about their designated 
Claims Assistrover, including contact details and approval preferences. Users can also 
request changes to their assigned approver if necessary. 
...
![Admin Dashboard](../image/approver-1.png)
## Claims

![Admin Dashboard](../image/approver-2.png)
## Advance View

### user all details here

![Admin Dashboard](../image/approver-3.png)

## Advance Table View
![Admin Dashboard](../image/approver-4.png)

## Claim Table View

![Admin Dashboard](../image/approver-5.png)
